    ...
    <Container maxW="container.xl" py={20}>
      <VStack spacing={16} align="center">
        ...
        <Flex direction="column" gap={8} w="full" maxW="md" >
            <Stat bg="#45a2f8" p={6} borderRadius="lg" mt={50}>
              <StatLabel color="white" mb={2}>Network</StatLabel>
              <StatNumber>{caipNetwork?.name || 'Unknown Network'}</StatNumber>
            </Stat>

            <Stat bg="#45a2f8" p={6} borderRadius="lg">
              <StatLabel color="white" mb={2}>Address</StatLabel>
            ...
            <Stat bg="#45a2f8" p={6} borderRadius="lg">
              <StatLabel color="white" mb={2}>Balance</StatLabel>
